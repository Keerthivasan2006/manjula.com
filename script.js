  ...
  renderStatsSection() {
    return `
            <section class="services-section" style="background-color: rgba(15, 23, 42, 0.5);">
                <div class="container">
                    <!-- Make stats grid responsive with auto-fit -->
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap: 20px;">
                        <div style="text-align: center;">
                            <div style="font-size: 28px; font-weight: 700; color: #fb923c; margin-bottom: 8px;">5000+</div>
                            <p style="color: #94a3b8; font-size: 12px; margin: 0;">Devices Repaired</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="font-size: 28px; font-weight: 700; color: #fb923c; margin-bottom: 8px;">98%</div>
                            <p style="color: #94a3b8; font-size: 12px; margin: 0;">Satisfaction</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="font-size: 28px; font-weight: 700; color: #fb923c; margin-bottom: 8px;">24hrs</div>
                            <p style="color: #94a3b8; font-size: 12px; margin: 0;">Express Service</p>
                        </div>
                        <div style="text-align: center;">
                            <div style="font-size: 28px; font-weight: 700; color: #fb923c; margin-bottom: 8px;">15+</div>
                            <p style="color: #94a3b8; font-size: 12px; margin: 0;">Technicians</p>
                        </div>
                    </div>
                </div>
            </section>
    ...
    const html = `
            <div class="products-section">
                <div class="products-header">
                    ...
                    <!-- Responsive search bar that doesn't overflow -->
                    <div style="margin-top: 24px; display: flex; gap: 8px; width: 100%; box-sizing: border-box; flex-wrap: wrap;">
                        ...
                        >
                        <button class="btn btn-secondary" style="white-space: nowrap; padding: 10px 12px; font-size: 12px;" onclick="document.getElementById('productSearch').value = ''; app.renderPage('products')">Clear</button>
                    </div>
                </div>
